"""Jailbreak attack safety test suite.

Tests an agent's resistance to jailbreak attempts including roleplay,
encoding, persona, and system override attacks.
"""
...
_DEFAULT_PAYLOADS_PATH = Path(__file__).parent.parent / "payloads" / "jailbreak.yaml"


@register_suite
class JailbreakSuite(SafetySuite):
    """Tests agent resistance to jailbreak attacks."""
    ...
    def _load_payloads(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.exception("Failed to load jailbreak payloads")
            return []
